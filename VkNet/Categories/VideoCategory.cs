...
namespace VkNet.Categories
{
    ...
    public class VideoCategory
    {
        ...
        [Pure]
        [ApiVersion( "5.9" )]
        public ReadOnlyCollection<Video> Get( long? ownerId = null, long? albumId = null,
            VideoWidth width = VideoWidth.Medium160, int? count = null, int? offset = null, bool extended = false )
        {
            ...
            VkResponseArray response = this._vk.Call( "video.get", parameters );
        ...
        /// </remarks>
        [ApiVersion( "5.9" )]
        public bool Edit( long videoId, long? ownerId = null, string name = null, string desc = null,
            string privacyView = null, string privacyComment = null, bool isRepeat = false )
        {
            ...
            return this._vk.Call( "video.edit", parameters );
        }
        ...
        public long Add( long videoId, long? ownerId = null )
        {
            ...
            VkResponse response = this._vk.Call( "video.add", parameters );
        ...
        /// </remarks>
        [ApiVersion( "5.9" )]
        public Video Save( string name = null, string description = null, bool isPrivate = false,
            bool isPostToWall = false, string link = null, long? groupId = null, long? albumId = null,
            bool isRepeat = false )
        {
            var parameters = new VkParameters
            {
            ...
            return this._vk.Call( "video.save", parameters );
        }
        ...
        public bool Delete( long videoId, long? ownerId = null )
        {
            ...
            return this._vk.Call( "video.delete", parameters );
        }
        ...
        public bool Restore( long videoId, long? ownerId = null )
        {
            ...
            return this._vk.Call( "video.restore", parameters );
        }
        ...
        [Pure]
        [ApiVersion( "5.9" )]
        public ReadOnlyCollection<Video> Search( string query, VideoSort sort, bool isHd = false, bool isAdult = false,
            VideoFilters filters = null, bool isSearchOwn = false, int? count = null, int? offset = null )
        {
            ...
            VkResponseArray response = this._vk.Call( "video.search", parameters );
            return response.ToReadOnlyCollectionOf<Video>( x => x );
        }
        ...
        public ReadOnlyCollection<Video> GetUserVideos( long userId, int? count = null, int? offset = null )
        {
            ...
            VkResponseArray response = this._vk.Call( "video.getUserVideos", parameters );
        ...
        [Pure]
        [ApiVersion( "5.9" )]
        public ReadOnlyCollection<VideoAlbum> GetAlbums( long ownerId, int? count = null, int? offset = null,
            bool extended = false )
        {
            VkErrors.ThrowIfNumberIsNegative( () => count );
            VkErrors.ThrowIfNumberIsNegative( () => offset );
            ...
            VkResponseArray response = this._vk.Call( "video.getAlbums", parameters );
        ...
        public long AddAlbum( string title, long? groupId = null )
        {
            ...
            VkResponse response = this._vk.Call( "video.addAlbum", parameters );
        ...
        public bool EditAlbum( long albumId, string title, long? groupId = null )
        {
            ...
            return this._vk.Call( "video.editAlbum", parameters );
        }
        ...
        public bool DeleteAlbum( long albumId, long? groupId = null )
        {
            ...
            return this._vk.Call( "video.deleteAlbum", parameters );
        }
        ...
        public bool MoveToAlbum( IEnumerable<long> videoIds, long albumId, long? groupId = null )
        {
            ...
            return this._vk.Call( "video.moveToAlbum", parameters );
        }
        ...
        [Pure]
        [ApiVersion( "5.9" )]
        public ReadOnlyCollection<Comment> GetComments( long videoId, long? ownerId = null, bool needLikes = false,
            int? count = null, int? offset = null, CommentsSort sort = null )
        {
            VkErrors.ThrowIfNumberIsNegative( () => videoId );
            VkErrors.ThrowIfNumberIsNegative( () => count );
            VkErrors.ThrowIfNumberIsNegative( () => offset );
            ...
            VkResponse response = this._vk.Call( "video.getComments", parameters );
        ...
        public long CreateComment( long videoId, string message, long? ownerId, bool isFromGroup = false )
        {
            ...
            return this._vk.Call( "video.createComment", parameters );
        }
        ...
        public bool DeleteComment( long commentId, long? ownerId )
        {
            ...
            return this._vk.Call( "video.deleteComment", parameters );
        }
        ...
        public bool RestoreComment( long commentId, long? ownerId )
        {
            ...
            return this._vk.Call( "video.restoreComment", parameters );
        }
        ...
        public bool EditComment( long commentId, string message, long? ownerId )
        {
            ...
            return this._vk.Call( "video.editComment", parameters );
        }
        ...
        public ReadOnlyCollection<Tag> GetTags( long videoId, long? ownerId )
        {
            ...
            VkResponseArray response = this._vk.Call( "video.getTags", parameters );
        ...
        public long PutTag( long videoId, long userId, long? ownerId, string taggedName )
        {
            ...
            return this._vk.Call( "video.putTag", parameters );
        }
        ...
        public bool RemoveTag( long tagId, long videoId, long? ownerId )
        {
            ...
            return this._vk.Call( "video.removeTag", parameters );
        }
        ...
        public ReadOnlyCollection<Video> GetNewTags( int? count = null, int? offset = null )
        {
            ...
            VkResponseArray response = this._vk.Call( "video.getNewTags", parameters );
        ...
        /// </remarks>
        [ApiVersion( "5.9" )]
        public bool Report( long videoId, VideoReportType reason, long? ownerId, string comment = null,
            string searchQuery = null )
        {
            ...
            return this._vk.Call( "video.report", parameters );
        }
        ...
        public bool ReportComment( long commentId, long ownerId, VideoReportType reason )
        {
            ...
            return this._vk.Call( "video.reportComment", parameters );
        }
    }
}