...
namespace VkNet.Categories
{
    ...
    public class AccountCategory
    {
        ...
        {
            return this._vk.Call( "account.getCounters", new VkParameters() { { "filter", filter } } );
        }
        ...
        public bool SetNameInMenu( [NotNull] string name )
        {
            ...
            return this._vk.Call( "account.setNameInMenu", parameters );
        }
        ...
        public bool SetOnline( bool? voip = null )
        {
            ...
            return this._vk.Call( "account.setOnline", parameters );
        }
        ...
        {
            return this._vk.Call( "account.setOffline", VkParameters.Empty );
        }
        ...
        [ApiVersion( "5.21" )]
        public bool RegisterDevice( [NotNull] string token, string deviceModel, string systemVersion,
            bool? noText = null, SubscribeFilter subscribe = null )
        {
            ...
            return this._vk.Call( "account.registerDevice", parameters );
        }
        ...
        public bool UnregisterDevice( [NotNull] string token )
        {
            ...
            return this._vk.Call( "account.unregisterDevice", parameters );
        }
        ...
        /// <returns>Возвращает результат выполнения метода.</returns>
        [ApiVersion( "5.21" )]
        public bool SetSilenceMode( [NotNull] string token, int? time = null, int? chatID = null, int? userID = null,
            bool? sound = null )
        {
            VkErrors.ThrowIfNullOrEmpty( () => token );
            ...
            if ( sound.HasValue )
            {
                parameters.Add( "sound", sound.Value );
                    // Cause Add(string, bool?) deletes parameter whem bool? value equals to false.
            }

            return this._vk.Call( "account.setSilenceMode", parameters );
        }
        ...
        public bool BanUser( int userId )
        {
            ...
            return this._vk.Call( "account.banUser", new VkParameters { { "user_id", userId } } );
        }
        ...
        public bool UnbanUser( int userId )
        {
            ...
            return this._vk.Call( "account.unbanUser", new VkParameters() { { "user_id", userId } } );
        }
        ...
        public IEnumerable<User> GetBanned( out int total, int? offset = null, int? count = null )
        {
            ...
            var response = this._vk.Call( "account.getBanned", parameters );
        ...
        {
            return this._vk.Call( "account.getInfo", VkParameters.Empty );
        }
        ...
        public bool SetInfo( int? intro = null )
        {
            ...
            return this._vk.Call( "account.setInfo", new VkParameters() { { "intro", intro } } );
        }
        ...
        {
            var info = this._vk.Call( "account.getProfileInfo", VkParameters.Empty );
            ...
            if ( !( info.ContainsKey( "uid" ) || info.ContainsKey( "id" ) ) && this._vk.UserId.HasValue )
            {
                string modifiedAnswer = Regex.Replace( info.RawJson, @"'response': {",
                    @"'response': { id: " + this._vk.UserId.Value + @", ",
        ...
        public bool SaveProfileInfo( int cancelRequestId )
        {
            ...
            return
                this._vk.Call( "account.saveProfileInfo",
                    new VkParameters() { { "cancel_request_id", cancelRequestId } } )[ "changed" ]
                ;
        }
        ...
        [ApiVersion( "5.21" )]
        public bool SaveProfileInfo( string firstName = null, string lastName = null, string maidenName = null,
            Sex? sex = null,
            RelationType? relation = null, long? relationPartnerId = null, DateTime? birthDate = null,
            BirthdayVisibility? birthDateVisibility = null,
            string homeTown = null, long? countryId = null, long? cityId = null )
        {
            ChangeNameRequest request;
            return this.SaveProfileInfo( out request, firstName, lastName, maidenName, sex, relation, relationPartnerId,
        ...
        /// <returns>Результат выполнения операции.</returns>
        [ApiVersion( "5.21" )]
        public bool SaveProfileInfo( out ChangeNameRequest changeNameRequest, string firstName = null,
            string lastName = null, string maidenName = null, Sex? sex = null,
            RelationType? relation = null, long? relationPartnerId = null, DateTime? birthDate = null,
            BirthdayVisibility? birthDateVisibility = null,
            string homeTown = null, long? countryId = null, long? cityId = null )
        {
            ...
            var response = this._vk.Call( "account.saveProfileInfo", parameters );
