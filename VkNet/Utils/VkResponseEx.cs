...
namespace VkNet.Utils
{
    internal static class VkResponseEx
    {
        ...
        public static Collection<T> ToCollectionOf<T>( this VkResponse response, Func<VkResponse, T> selector )
            //where T : class
        {
            if ( response == null )
            {
        ...
        public static Collection<T> ToCollectionOf<T>( this IEnumerable<VkResponse> responses,
