// Autogenerated at 06.11.2014 10:28:12
...
namespace VkNet.Utils
{
    partial class VkResponse
    {
        ...
        {
            return response == null || response._token == null || !response._token.HasValues
                ? null
                : AccountInfo.FromJson( response );
        }
        ...
        public static implicit operator ApplicationContent( VkResponse response )
        {
            return response == null || response._token == null || !response._token.HasValues
                ? null
                : ApplicationContent.FromJson( response );
        }
