...
namespace VkNet.Enums.Filters
{
    ...
    public sealed class GroupsFields : MultivaluedFilter<GroupsFields>
    {
        ...
        /// </summary>
        public static readonly GroupsFields All = CityId | CountryId | Place | Description | WikiPage | MembersCount |
                                                  Counters |
                                                  StartDate | EndDate | CanPost | CanSeelAllPosts | CanCreateTopic |
                                                  Activity | Status | Contacts | Links | FixedPostId |
                                                  IsVerified | Site;
